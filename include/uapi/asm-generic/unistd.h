...
#define __NR_count_redactions 457
__SYSCALL(__NR_count_redactions, sys_count_redactions)
#define __NR_reset_redactions 458
__SYSCALL(__NR_reset_reedactions, sys_reset_redactions)
